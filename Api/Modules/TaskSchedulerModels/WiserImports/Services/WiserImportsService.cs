...
using Api.Modules.TaskSchedulerModels.WiserImports.Interfaces;
...
namespace Api.Modules.TaskSchedulerModels.WiserImports.Services;
...
public class WiserImportsService : IWiserImportsService, IActionsService, IScopedService
{
    ...
    public Task InitializeAsync(ImportFiles.Models.ConfigurationModel configuration, HashSet<string> tablesToOptimize)
    {
