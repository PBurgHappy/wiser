...
namespace Api.Modules.TaskSchedulerModels.WTSInterfaces
{
    ...
    public interface  IConfigurationsService
    {
        ...
        Task ExtractActionsFromConfigurationAsync(int timeId, ImportFiles.Models.ConfigurationModel configuration);
        ...
        /// <returns></returns>
        Task<bool> IsValidConfigurationAsync(ImportFiles.Models.ConfigurationModel configuration);
